...
[_QWERTY] = LAYOUT_planck_grid(
    MU_TOG,              LCTL_T(KC_1), LALT_T(KC_2), LGUI_T(KC_3), KC_4, KC_5, KC_6, KC_7, KC_8,    KC_9,   KC_0,    KC_SPC,
...
[_LOWER] = LAYOUT_planck_grid(
    MUSE,    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, AUTOTEXT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
...
char auto_text_string[50] = "What a stupid keymap this is";
